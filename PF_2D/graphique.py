...
def graphique(A_exact,B_exact,A_eta,B_eta,L1_eta,L2_eta,all_eta,A_final,B_final,L1_final,L2_final,tf,N):
    ...
    surf = ax.plot_surface(xx, yy, A_final[:,0].reshape((N,N)),cmap=cm.coolwarm)
    ax.set_xlabel('x', fontsize=10)
    ax.set_ylabel('y', fontsize=10)
    ax.set_xticks([0,0.5,1]) 
    ax.set_yticks([0,0.5,1]) 
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.set_title(f'A(x,y) at t=0 ')

    ax = fig.add_subplot(2, 4, 2, projection='3d')
    surf = ax.plot_surface(xx, yy, A_final[:,20].reshape((N,N)),cmap=cm.coolwarm)
    ax.set_xlabel('x', fontsize=10)
    ax.set_ylabel('y', fontsize=10)
    ax.set_xticks([0,0.5,1]) 
    ax.set_yticks([0,0.5,1]) 
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.set_title(f'A(x,y) at t=0.02 ')
    
    ax = fig.add_subplot(2, 4, 3, projection='3d')
    surf = ax.plot_surface(xx, yy, A_final[:,200].reshape((N,N)),cmap=cm.coolwarm)
    ax.set_xlabel('x', fontsize=10)
    ax.set_ylabel('y', fontsize=10)
    ax.set_xticks([0,0.5,1]) 
    ax.set_yticks([0,0.5,1]) 
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.set_title(f'A(x,y) at t=0.2 ')
    
    ax = fig.add_subplot(2, 4, 4, projection='3d')
    surf = ax.plot_surface(xx, yy, A_final[:,-1].reshape((N,N)),cmap=cm.coolwarm)
    ax.set_xlabel('x', fontsize=10)
    ax.set_ylabel('y', fontsize=10)
    ax.set_xticks([0,0.5,1]) 
    ax.set_yticks([0,0.5,1]) 
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.set_title(f'A(x,y) at t=1 ')
    
    ax = fig.add_subplot(2, 4, 5, projection='3d')
    surf = ax.plot_surface(xx, yy, B_final[:,0].reshape((N,N)),cmap=cm.coolwarm)
    ax.set_xlabel('x', fontsize=10)
    ax.set_ylabel('y', fontsize=10)
    ax.set_xticks([0,0.5,1]) 
    ax.set_yticks([0,0.5,1]) 
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.set_title(f'B(x,y) at t=0 ')
    
    ax = fig.add_subplot(2, 4, 6, projection='3d')
    surf = ax.plot_surface(xx, yy, B_final[:,20].reshape((N,N)),cmap=cm.coolwarm)
    ax.set_xlabel('x', fontsize=10)
    ax.set_ylabel('y', fontsize=10)
    ax.set_xticks([0,0.5,1]) 
    ax.set_yticks([0,0.5,1]) 
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.set_title(f'B(x,y) at t=0.02 ')
    
    ax = fig.add_subplot(2, 4, 7, projection='3d')
    surf = ax.plot_surface(xx, yy, B_final[:,200].reshape((N,N)),cmap=cm.coolwarm)
    ax.set_xlabel('x', fontsize=10)
    ax.set_ylabel('y', fontsize=10)
    ax.set_xticks([0,0.5,1]) 
    ax.set_yticks([0,0.5,1]) 
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.set_title(f'B(x,y) at t=0.2 ')
    
    ax = fig.add_subplot(2, 4, 8, projection='3d')
    surf = ax.plot_surface(xx, yy, B_final[:,-1].reshape((N,N)),cmap=cm.coolwarm)
    ax.set_xlabel('x', fontsize=10)
    ax.set_ylabel('y', fontsize=10)
    ax.set_xticks([0,0.5,1]) 
    ax.set_yticks([0,0.5,1]) 
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.set_title(f'B(x,y) at t=1 ')
    
    plt.savefig('PF_2D.png', dpi=120)
    plt.show()
